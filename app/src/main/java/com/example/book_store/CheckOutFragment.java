...
public class CheckOutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String name = preferenceManager.getString(Constants.LOGIN_NAME); // Lấy tên
        String address = "None"; // Lấy địa chỉ;

        // Nếu người dùng đăng nhập bằng Google Sign-In (phone == null)
        if (phone == null || phone.isEmpty()) {
            // Hiển thị thông tin mặc định
            txtName.setText(name != null ? name : "Unknown User");
        ...
        databaseReference.child(timestamp).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                getParentFragmentManager().beginTransaction().replace(R.id.container,orderDetailFragment)
                        .addToBackStack("CheckOutFragment").commit();
            }
