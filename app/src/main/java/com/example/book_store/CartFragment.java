        ...
        btnCheckOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cartRecyclerView.getChildCount() == 0) {
                    ...
                    Toast.makeText(getContext(), "Giỏ hàng không có sản phẩm nào!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                getParentFragmentManager().beginTransaction().replace(R.id.container,checkOutFragment).addToBackStack(null).commit();
//                PreferenceManager preferenceManager = new PreferenceManager(getContext(),Constants.LOGIN_KEY_PREFERENCE_NAME);
