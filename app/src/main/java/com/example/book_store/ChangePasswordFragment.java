    ...
    private void updatePassword() {
        readData(new MyCallBack() {
            ...
            public void onCallback(String value) {
                ...
                pass = value;
                if (pass.equals(txtPass.getText().toString()) && !pass.equals(txtNewPass.getText().toString())) {
                ...
                else if (pass.equals(txtPass.getText().toString()) && pass.equals(txtNewPass.getText().toString()))
                {
                    Toast.makeText(getActivity(), "Mat khau moi khong duoc trung voi mat khau cu", Toast.LENGTH_SHORT).show();
                }
                else Toast.makeText(getActivity(), "Mat khau hien tai khong chính xác", Toast.LENGTH_SHORT).show();
            }
        });
    }
